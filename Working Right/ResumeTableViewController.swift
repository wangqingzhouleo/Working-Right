...
class ResumeTableViewController: UITableViewController {
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCellWithIdentifier("ResumeCell", forIndexPath: indexPath)

        // Configure the cell...
        cell.textLabel?.numberOfLines = 0
        cell.textLabel?.text = resumeList[indexPath.row]
    ...
    func loadData()
    {
        if let path = NSBundle.mainBundle().pathForResource("Resume", ofType: "json")
        {
            do
            {
